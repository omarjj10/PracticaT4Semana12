...
public class AnimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText edNombre = findViewById(R.id.editNuevoNombre);
        EditText edDescripcion = findViewById(R.id.editNuevaDes);
        EditText edImagen = findViewById(R.id.editNuevaImagen);
        String texto=String.valueOf(AnimeAdapter.codigo);
        Log.i("APP_VJ20202",texto);
        btnEditar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<Anime> call=service.update(AnimeAdapter.codigo,animes);
